 ...
 * Generation date: Tue Feb 13 09:54:00 2024
 */
...
public class Obra extends com.matisse.reflect.MtObject {
    ...
    /* Relationship 'escrita_por' */

    /** Relationship <code>escrita_por</code> cache ID */
    private static int escrita_porCID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtRelationship.Loader("escrita_por",CID));

    /**
     * Gets the <code>escrita_por</code> relationship descriptor.
     * This method supports advanced MATISSE programming techniques such as
     * dynamically modifying the schema.
     * @param db a database
     * @return a relationship descriptor object
     */
    public static com.matisse.reflect.MtRelationship getEscrita_porRelationship(com.matisse.MtDatabase db) {
        return (com.matisse.reflect.MtRelationship)db.getCachedObject(escrita_porCID);
    }

    /**
     * Gets the <code>escrita_por</code> relationship's successors.
     * @return an array of objects
     *
     * @see #getEscrita_porSize
     * @see #escrita_porIterator
     * @see #setEscrita_por
     * @see #removeEscrita_por
     */
    public final biblioteca.Autor[] getEscrita_por() {
        return (biblioteca.Autor[])getSuccessors(getEscrita_porRelationship(getMtDatabase()), biblioteca.Autor.class);
    }

    /**
     * Counts the <code>escrita_por</code> relationship's successors.
     ...
     * @see #removeEscrita_por
     */
    public final int getEscrita_porSize() {
        return getSuccessorSize(getEscrita_porRelationship(getMtDatabase()));
    }

    /**
     * Opens an iterator on the <code>escrita_por</code> relationship's successors.
     ...
     * @see #removeEscrita_por
     */
    public final <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> escrita_porIterator() {
        return this.<E>successorIterator(getEscrita_porRelationship(getMtDatabase()), biblioteca.Autor.class);
    }

    /**
     * Sets the <code>escrita_por</code> relationship's successors.
     ...
     * @see #removeEscrita_por
     */
    public final void setEscrita_por(biblioteca.Autor[] succs) {
        setSuccessors(getEscrita_porRelationship(getMtDatabase()), succs);
    }

    /**
     * Inserts one object at the beginning of the existing <code>escrita_por</code> successors list.
     ...
     * @see #removeEscrita_por
     */
    public final void prependEscrita_por(biblioteca.Autor succ) {
        prependSuccessor(getEscrita_porRelationship(getMtDatabase()), succ);
    }

    /**
     * Adds one object to the end of the existing <code>escrita_por</code> successors list.
     * @param succ the object to add
     *
     * @see #getEscrita_por
     * @see #setEscrita_por
     ...
     * @see #escrita_porIterator
     */
    public final void appendEscrita_por(biblioteca.Autor succ) {
        appendSuccessor(getEscrita_porRelationship(getMtDatabase()), succ);
    }
    /** Adds multiple objects to the end of the existing <code>escrita_por</code> successors list.
     ...
     * @see #escrita_porIterator
     */
    public final void appendEscrita_por(biblioteca.Autor[] succs) {
        addSuccessors(getEscrita_porRelationship(getMtDatabase()), succs);
    }

    /**
     * Removes objects from the <code>escrita_por</code> successors list.
     ...
     * @see #escrita_porIterator
     */
    public void removeEscrita_por(biblioteca.Autor[] succs) {
        removeSuccessors(getEscrita_porRelationship(getMtDatabase()), succs);
    }

    /**
     * Removes one object from the <code>escrita_por</code> successors list.
     ...
     * @see #escrita_porIterator
     */
    public void removeEscrita_por(biblioteca.Autor succ) {
        removeSuccessor(getEscrita_porRelationship(getMtDatabase()), succ);
    }

    /**
     * Removes all <code>escrita_por</code> successors.  When the minimum cardinality
     * is 1, a new successor must be set before commit.
     */
    public final void clearEscrita_por() {
        clearSuccessors(getEscrita_porRelationship(getMtDatabase()));
    }
